...
import {
  ...
  withdrawalFiatBlack,
  newWidthrawIcon,
  WithdrawalCryptoWhite,
  WithdrawalCryptoBlack,
} from "../../../helper/ImageAssets";
import NavigationService from "../../../navigation/NavigationService";
import { SELECT_COIN_SCREEN, WITHDRAW_FIAT_SCREEN } from "../../../navigation/routes";
import Toast from "react-native-simple-toast";

const WithdrawChoiceSheet = ({ sheetRef, isDark, onSelectFiat }) => {
  const handleWithdrawCrypto = () => {
    sheetRef.current?.close?.();
    NavigationService.navigate(SELECT_COIN_SCREEN);
  };
        ...
        <View style={styles.optionsList}>
          ...
          >
            <View style={styles.optionLeft}>
              ...
              >
                <FastImage
                  source={isDark ? WithdrawalCryptoWhite : WithdrawalCryptoBlack}
              ...
              <View style={styles.textWrap}>
                ...
                <AppText
                  ...
                  color={subTextColor}
                >
                  Withdraw crypto assets via the blockchain
                </AppText>
              </View>
            </View>
            <AppText
          ...
          >
            <View style={styles.optionLeft}>
              ...
              >
                <FastImage
                  source={isDark ? withdrawalFiatWhite : withdrawalFiatBlack}
                  style={styles.actionIcon}
                  resizeMode={FastImage.resizeMode.contain}
                />
              </View>
...
export default WithdrawChoiceSheet;
