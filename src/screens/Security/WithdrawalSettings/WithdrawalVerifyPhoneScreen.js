...
const WithdrawalVerifyPhoneScreen = () => {
  ...
  const userPhone = userData?.mobileNumber ?? userData?.mobile_number ?? '+91**********0';
    ...
    <AppSafeAreaView style={{ backgroundColor: isDark ? '#121214' : '#FFFFFF', flex: 1 }}>
      <View style={styles.flex}>
        ...
        <View style={styles.content}>
          ...
          >
            The verification code has been sent to your phone {userPhone}, valid for 10 minutes.
          </AppText>
...
export default WithdrawalVerifyPhoneScreen;
