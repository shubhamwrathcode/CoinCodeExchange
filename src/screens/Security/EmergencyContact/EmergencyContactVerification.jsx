...
const EmergencyContactVerification = () => {
  ...
  const handleConfirm = () => {
    ...
    // Navigate back to the main Emergency Contact screen with the data parameter
    navigation.navigate(routes.EMERGENCY_CONTACT_SCREEN, {
  ...
  return (
    <AppSafeAreaView style={{ backgroundColor: isDark ? '#121214' : colors.white, flex: 1 }}>
      <View style={styles.flex}>
        ...
        <View style={styles.content}>
          ...
          >
            Enter the 6-digit verification code sent to your email/phone to authorize adding this emergency contact.
          </AppText>
        ...
        {!isKeyboardVisible && (
          <View style={styles.bottomWrapper}>
            ...
            >
              <AppText type={SIXTEEN} weight={BOLD} style={{ color: isDark ? '#000000' : '#FFFFFF' }}>
                Confirm
              </AppText>
            </TouchableOpacity>
